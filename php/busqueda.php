...
$user_id=null;
$sql1= "select * from equipo where $_GET[sel1] like '%$_GET[s]%' ";
echo "Filtro aplicado: '$_GET[sel1]' con el parametro: '$_GET[s]'";
$query = $con->query($sql1);
?>
<p>
<?php if($query->num_rows>0):?>
<p>
<table id="tbbusqueda" class="table table-hover table-responsive">
<thead>
